...
export const AdminIcon: React.FC<AdminIconProps> = ({ className = "", size = 24 }) => {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="10" height="10" x="1" y="1" fill="currentColor" rx="1" strokeWidth="0.5" stroke="#ffffff">
      ...
      <rect width="10" height="10" x="1" y="13" fill="currentColor" rx="1" strokeWidth="0.5" stroke="#ffffff">
      ...
      <rect width="10" height="10" x="13" y="13" fill="currentColor" rx="1" strokeWidth="0.5" stroke="#ffffff">
