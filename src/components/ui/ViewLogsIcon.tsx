...
interface ViewLogsIconProps {
  className?: string;
  size?: number;
}

export const ViewLogsIcon: React.FC<ViewLogsIconProps> = ({ className = "", size = 24 }) => {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="2.8" height="12" x="1" y="6" fill="currentColor" strokeWidth="0.5" stroke="#ffffff">
      ...
      <rect width="2.8" height="12" x="5.8" y="6" fill="currentColor" strokeWidth="0.5" stroke="#ffffff">
      ...
      <rect width="2.8" height="12" x="10.6" y="6" fill="currentColor" strokeWidth="0.5" stroke="#ffffff">
      ...
      <rect width="2.8" height="12" x="15.4" y="6" fill="currentColor" strokeWidth="0.5" stroke="#ffffff">
        <animate attributeName="y" begin="SVGKWB9Ob0W.begin+0.2s" calcMode="spline" dur="0.6s" keySplines=".14,.73,.34,1;.65,.26,.82,.45" values="6;1;6" />
        <animate attributeName="height" begin="SVGKWB9Ob0W.begin+0.2s" calcMode="spline" dur="0.6s" keySplines=".14,.73,.34,1;.65,.26,.82,.45" values="12;22;12" />
      </rect>
      <rect width="2.8" height="12" x="20.2" y="6" fill="currentColor" strokeWidth="0.5" stroke="#ffffff">
