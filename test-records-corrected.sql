-- Test Records for Calendar Date Picker Testing (Corrected Column Names)
-- Run this SQL in your Supabase SQL Editor to create test data
-- This version uses the correct column names for your saved_logs table

-- Insert test records spanning multiple months for comprehensive date picker testing
INSERT INTO saved_logs (id, date, month, total_records, log_data, csv_content, summary_content, saved_at) VALUES
